...
3. Si la base es **antigua** (sin políticas RLS): `patch_001_rls_policies.sql`. Para **usuarios y login**: `patch_002_users_auth.sql` (tabla `kf_users` y columna `user_id` en movimientos).
